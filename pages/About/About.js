...
export const About = () => {
    ...
    <section class="about">
            <p>
            Me presento como un programador full stack junior altamente motivado y apasionado por la creación de 
            ...
            Encontré mi segunda pasión en la vida a través de la programación, ya que encuentro muchas similitudes con la manera de abordar los 
            lenguajes y para qué sirven y cómo aplicarlos.
            </p>
            <br>
            <p>
            Con sólidos conocimientos en JavaScript (JS) y TypeScript (TS), junto con los frameworks Angular y React, puedo crear interfaces 
            ...
            <br>
            <p>
            Como programador full stack junior, también tengo conocimientos en la configuración y administración de hosting y despliegue de
            ...
            <br>
            <p>Perfil competencial</p>

            <p>Dirección y Liderazgo:</p>
            <br>
            <p>
            De manera general, suelo tener alta tendencia a aspirar cada vez a metas más altas, con perseverancia y convicción. Se puede decir
            que soy un profesional con alta tendencia a generar relaciones y a crear un buen clima de trabajo. Me centro en conocer e impulsar
            el desarrollo del talento individual para transformarlo en alta competencia colectiva, de modo que, liderando a cada uno y a todos en conjunto desde mis fortalezas, logro llevar al equipo a un nivel superior.
            De manera general, suelo ser metódico en mis decisiones y manera de pensar. Las normas y la noción de lo correcto son pilares
            fundamentales en la manera en la que miro la vida. Normalmente, soy una persona que se siente cómoda en funciones donde existen 
            reglas y parámetros específicos, para saber dónde y cómo moverme.
            Me guío por mi sentido de la responsabilidad y moral. Tiendo a ser una persona ordenada y planificada. Siento afinidad
            con ambientes que estimulan el pensamiento metódico.
            </p>
            <br>
